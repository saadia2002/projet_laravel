...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-8 text-center">
            <div class="button-container">
                <a href="{{URL::to('/login1')}}" class="btn btn-danger py-md-3 px-md-5 mt-2">Log In</a>
                <a href="{{URL::to('/creation')}}" class="btn btn-primary py-md-3 px-md-5 mt-2">Sign Up</a>
            </div>
        </div>
    </div>
    ...
    <script>
   swal("your account is created succefully!", "you can log in now to reserve your flight", "success");
    </script>
@endif
